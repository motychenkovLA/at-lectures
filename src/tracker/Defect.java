...
public class Defect {
   ...
   public Defect (String resume, String severity, int dueDates){
       this.id++;
       this.resume = resume;
   ...
   public void getInfo(){
        System.out.println(id + " | Резюме: " + resume + " | Критичность дефекта: " + severity +
                " | Количество дней на исправление: " + dueDates +
